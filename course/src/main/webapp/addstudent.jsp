...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" action="${pageContext.request.contextPath}/addStudent">
                <div class="form-group">
                    <label for="reg_no" class="col-sm-2 control-label">学号</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="reg_no" name="reg_no" placeholder="请输入学号">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group" align="right">
                    <input type="submit" value="点击新增学生" class="btn btn-primary">
                </div>
            </form>
        </div>
    </div>
